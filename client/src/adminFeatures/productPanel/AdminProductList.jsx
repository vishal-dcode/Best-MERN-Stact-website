...
import { DISCOUNT_PRICE, ITEMS_PER_PAGE } from "../../app/constants.js";
...
function ProductGrid({ products }) {
  return (
    <div className="bg-white">
      <Link to="/admin/product-form" className="bg-green-200">
        Add Product
      </Link>{" "}
      <Link to="/admin/orders" className="bg-green-200">
        All Orders
      </Link>
                ...
                <div className="group relative border-solid border-2 p-2 border-gray-200">
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-sm block line-through font-medium text-gray-400">${DISCOUNT_PRICE(product)}</p>
                    </div>
                  </div>
                </div>
              </Link>
              <Link to={`/admin/product-detail/edit/${product.id}`} className="p-2 bg-gray-200">
                Edit Product
              </Link>
            </section>
          ))}
