  ...
  return (
    <form
      ...
      onSubmit={handleSubmit((data) => {
        const products = { ...data };
        products.images = [products.image1, products.image2, products.image3, products.thumbnail];
    ...
    >
              ...
              <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                <div className="text-center">
                  ...
                  >
                    ...
                    <input id="thumbnail" name="thumbnail" type="url" className="" />
                  </label>
      ...
      <div className="mt-6 flex items-center justify-end gap-x-6">
        ...
        {selectProductById && ( // this delete will only show when a existing product is selected
          <button onClick={handleDelete} type="button" className="text-sm font-semibold leading-6 text-gray-900">
            Delete
          </button>
        )}
        <button
