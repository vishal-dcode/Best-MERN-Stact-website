  ...
  return (
    <section className="profile_page-ctr">
      <div className="profile_type">
        ...
        <span>Account type: {userInfoSelector.role ? userInfoSelector.role : 'User'}</span>
      </div>
      <div>
        <h1 className="profile_name">{userInfoSelector.userName ? userInfoSelector.userName : 'New User'}</h1>
        ...
        {userInfoSelector.addresses[0] && (
          <div className="profile_page-info">
            <div className="flex gap-1">
              <span>Email:</span> {userInfoSelector.email} ~ <span>Phone:</span> {userInfoSelector.addresses[0].phone}
            </div>
            <div>
              <p>
