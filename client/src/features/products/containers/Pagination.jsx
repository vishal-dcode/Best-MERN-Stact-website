...
export default function Pagination({
  ...
  const totalItems = useSelector((store) => store.productName.totalItems);
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            to{" "}
            <span className="font-medium">
              {totalItems > startPage * ITEMS_PER_PAGE + 1
                ? totalItems > startPage * ITEMS_PER_PAGE + ITEMS_PER_PAGE + 1
                  ? startPage * ITEMS_PER_PAGE + ITEMS_PER_PAGE + 1
                  : totalItems
                : totalItems}
            </span>{" "}
