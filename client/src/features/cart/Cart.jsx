              ...
              return (
                <li key={item.product.id} className="cart_items">
                  <figure className="h-32 w-32">
                    <img
                      src={item.product.thumbnail || 'placeholder-image-url'}
                  ...
                  <div className="cart_items-info">
                    <div>
                      <div className="cart_items-title">
                        <p className="order_id">{item.product.brand || 'Unknown Brand'}</p>
                  ...
                  <div className="close_icon-ctr">
                    <Modal
                      title={`Delete ${item.product.title || 'Product'}`}
                    ...
                    <button
                      ...
                      <svg width="42" height="42" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <line x1="9" y1="18" x2="9" y2="4.37114e-08" stroke="black" strokeWidth="2" />
                      </svg>
                    </button>
                  </div>
                </li>
