    ...
    <footer>
      ...
      <section className="about_me pt-10">
        <div>
          ...
          <p>
            I’m Vishal, a self-taught Web Developer & Designer who loves
            bringing ideas to life via my work and have a passion for creating
            and developing beautifully simple things.I’m Vishal, a self-taught
            Web Developer & Designer who loves bringing ideas to life via my
            work and have a passion for creating and developing beautifully
            simple things.
          </p>
        </div>
        <div className="social_ctr flex-wrap lg:flex-nowrap">
          ...
          <h2>
            <a
              ...
              download
              className="hover:text-blue-gray-900 lg:border-0">
              RESUME: DOWNLOAD
            </a>
          </h2>
        </div>
